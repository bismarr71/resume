                            ...
                            <div class="dropdown-menu dropdown-lg p-0 border-0 py-4 px-3 max-h-312" data-simplebar>
                                <div class="notification-menu d-flex flex-wrap justify-content-between gap-4">
                                    <a href="https://www.figma.com/" target="_blank"
                                        ...
                                        <img src="/assets-admin/images/figma.svg" class="wh-25" alt="united-states" />
                                        <span>Figma</span>
                                    </a>
                                    <a href="https://www.dribbble.com/" target="_blank"
                                        class="dropdown-item p-0 text-center">
                                        <img src="/assets-admin/images/dribbble.svg" class="wh-25"
                                            alt="united-states" />
                                        <span>Dribbble</span>
                                    </a>
                                    <a href="https://www.spotify.com/" target="_blank"
                                        class="dropdown-item p-0 text-center">
                                        <img src="/assets-admin/images/spotify.svg" class="wh-25"
                                            alt="united-states" />
                                        <span>Spotify</span>
                                    </a>
                                    <a href="https://www.github.com/" target="_blank"
                                        class="dropdown-item p-0 text-center">
                                        <img src="/assets-admin/images/github.svg" class="wh-25" alt="united-states" />
                                        <span>Github</span>
                                    </a>
                                    <a href="https://www.google.com/drive/" target="_blank"
                                        class="dropdown-item p-0 text-center">
                                        <img src="/assets-admin/images/gdrive.svg" class="wh-25" alt="united-states" />
                                        <span>GDrive</span>
                                    </a>
                                    <a href="https://www.trello.com/" target="_blank"
                                        class="dropdown-item p-0 text-center">
                                        <img src="/assets-admin/images/trello.svg" class="wh-25" alt="united-states" />
                                        <span>Trello</span>
                                    </a>
                                    <a href="https://www.slak.com/" target="_blank"
                                        class="dropdown-item p-0 text-center">
                                        <img src="/assets-admin/images/slak.svg" class="wh-25" alt="united-states" />
                                        <span>Slak</span>
                                    </a>
                                    <a href="https://www.pinterest.com/" target="_blank"
                                        class="dropdown-item p-0 text-center">
                                        <img src="/assets-admin/images/pinterest.svg" class="wh-25"
                                            alt="united-states" />
                                        <span>Pinterest</span>
                                    </a>
                                    <a href="https://www.facebook.com/" target="_blank"
                                        class="dropdown-item p-0 text-center">
                                        <img src="/assets-admin/images/facebook.svg" class="wh-25"
                                            alt="united-states" />
                                        <span>Facebook</span>
                                    </a>
                                    <a href="https://www.linkedin.com/" target="_blank"
                                        class="dropdown-item p-0 text-center">
                                        <img src="/assets-admin/images/linkedin.svg" class="wh-25"
                                            alt="united-states" />
                                        <span>Linkedin</span>
                                    </a>
                                </div>
                                ...
                                <div class="max-h-275" data-simplebar>
                                        ...
                                        <a href="javascript:void(0);" class="dropdown-item">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="/assets-admin/images/usa.svg"
                                                        class="wh-30 rounded-circle" alt="united-states" />
                                                </div>
                                    ...
                                    <div class="notification-menu">
                                        <a href="javascript:void(0);" class="dropdown-item">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="/assets-admin/images/canada.svg"
                                    ...
                                    <div class="notification-menu">
                                        <a href="javascript:void(0);" class="dropdown-item">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="/assets-admin/images/germany.svg"
                                                        class="wh-30 rounded-circle" alt="spain" />
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                    ...
                                    <div class="notification-menu">
                                        <a href="javascript:void(0);" class="dropdown-item">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="/assets-admin/images/portugal.svg"
                                    ...
                                    <div class="notification-menu mb-0">
                                        <a href="javascript:void(0);" class="dropdown-item">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="/assets-admin/images/spain.svg"
                                                        class="wh-30 rounded-circle" alt="spain" />
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                            ...
                            <div class="d-xxl-flex align-items-center bg-transparent border-0 text-start p-0 cursor dropdown-toggle"
                                ...
                                <div class="flex-shrink-0">
                                    <img class="rounded-circle wh-40 administrator"
                                        src="/assets-admin/images/administrator.jpg" alt="admin" />
                                </div>
                                <div class="flex-grow-1 ms-2">
